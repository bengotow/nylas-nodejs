...
describe('RestfulModelCollection', () => {
  ...
  describe('delete', () => {
    ...
    test('should accept a model id as the first parameter', done => {
    ...
    test('should work without params', done => {
    ...
    describe('test folder and label deletion', () => {
      ...
      test('label should populate delete request body if not provided', done => {
        testContext.collection = new RestfulModelCollection(
          Label,
          testContext.connection
        );
